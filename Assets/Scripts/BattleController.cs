...
public class BattleController : MonoBehaviour
{
    ...
    *********************************************/
    public void generateNewTestTeam() {
        ...
        for (int i = 0; i < 6; i++) {
            teams[Utils.ENEMY].placeCreature(i, new BaseCard("Enemy_"+i.ToString(), "Description_"+1.ToString(), Random.Range(1, 101), Random.Range(1, 101), Random.Range(1, 101), "beast"));
